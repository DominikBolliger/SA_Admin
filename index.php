...
<html lang="en">
    ...
    <body>
        <div class="grid-container">
            ...
            <div class="grid-item7 grid-div" id="canvas2Div"><canvas class="canvasCoord" id="canvas2">Your Browser is not able to show Canvas</canvas></div>
            <div class="grid-item8 grid-div"><p>Footer</p></div>
        </div>
